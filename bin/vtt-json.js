...
if (!argv._[2] || argv.help) {
  console.log("\nvtt-json.js input (output) (opts)\n\n" +
    ...
    "* opts (optional) :\n" +
    "  --plugins : a comma separated list of plugins. a plugin can either be one of the default plugins, npm modules, or a relative path to a custom plugin. Order of plugins matter. Default value : `timecode,region,text,json,html\n");
  process.exit(0);
}
...
var pluginsFiles = argv.plugins ? argv.plugins.split(',') : ['timecode', 'region', 'text', 'json', 'html'];
var plugins = [];
